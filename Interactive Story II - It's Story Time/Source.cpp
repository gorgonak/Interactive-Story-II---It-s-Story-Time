...
//I used these string variable functions to get user input for their name and for the choices they make for the story
string getUserName();
...
//the folllowing functions contain all the story elements, expand them to see the various functions inside
